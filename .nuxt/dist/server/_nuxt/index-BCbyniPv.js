import { l as arrow, _ as _export_sfc, m as mergeConfig, i as useUI, j as appConfig, d as __nuxt_component_2$2, e as __nuxt_component_1, k as get, t as twMerge, g as __nuxt_component_5$2, o as useInjectButtonGroup, s as select, p as selectMenu, c as useToast, b as useSupabaseUser, h as useRoute } from "../server.mjs";
import { u as useFormGroup, _ as __nuxt_component_0$1, a as __nuxt_component_1$1 } from "./Input-CUCmPBr7.js";
import { ref, computed, defineComponent, inject, watchEffect, nextTick, watch, provide, h, Fragment, toRaw, reactive, cloneVNode, shallowRef, unref, getCurrentInstance, Teleport, normalizeClass, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, createBlock, createCommentVNode, openBlock, Transition, toRef, useId, useSSRContext, resolveDynamicComponent, toDisplayString, renderList, createTextVNode, isRef, createSlots } from "/mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/index.mjs";
import { defu } from "/mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/defu/dist/defu.mjs";
import { A as A$3, i as i$2, a as i$3, o as o$2, u as u$4, T as T$1, l as l$1, b as i$4, c as i$5, s as s$2, d as u$5, w as w$2, t as t$4, E as E$3, e as c$1, f as f$3, O, N as N$3, g as o$3, n as n$1, h as c$2, j as w$3, S, P, k as N$4, m as t$5, p as p$1, q as w$4, r as h$1, v as E$4, x as T$2, y as s$3, z as S$1, B as usePopper, C as s$4 } from "./usePopper-CDUF8jSC.js";
import { ssrRenderComponent, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderStyle, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderVNode } from "vue/server-renderer";
import { b as __nuxt_component_0, _ as __nuxt_component_1$2, a as __nuxt_component_1$3 } from "./Select-PkSwbjSb.js";
import { twJoin } from "tailwind-merge";
import { upperFirst } from "/mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/scule/dist/index.mjs";
...
function e$1(i2 = {}, s2 = null, t2 = []) {
  for (let [r, n2] of Object.entries(i2)) o(t2, f$1(s2, r), n2);
  return t2;
}
function f$1(i2, s2) {
  return i2 ? i2 + "[" + s2 + "]" : s2;
...
function o(i2, s2, t2) {
  if (Array.isArray(t2)) for (let [r, n2] of t2.entries()) o(i2, f$1(s2, r.toString()), n2);
...
let ie = /* @__PURE__ */ Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a2, { slots: h$12 }) {
  ...
  function w2(t2 = (n2) => n2) {
    let n2 = d2.value !== null ? v2.value[d2.value] : null, s2 = t2(v2.value.slice()), b = s2.length > 0 && s2[0].dataRef.order.value !== null ? s2.sort((C2, A2) => C2.dataRef.order.value - A2.dataRef.order.value) : O(s2, (C2) => o$2(C2.dataRef.domRef)), O$1 = n2 ? b.indexOf(n2) : null;
    return O$1 === -1 && (O$1 = null), { options: b, activeOptionIndex: O$1 };
  }
  let M2 = computed(() => a2.multiple ? 1 : 0), $2 = computed(() => a2.nullable), [B2, p2] = d$4(computed(() => a2.modelValue), (t2) => y2("update:modelValue", t2), computed(() => a2.defaultValue)), R2 = computed(() => B2.value === void 0 ? u$5(M2.value, { [1]: [], [0]: void 0 }) : B2.value), V = null, i2 = null;
  function I(t2) {
    return u$5(M2.value, { [0]() {
  ...
  let l2 = { comboboxState: o2, value: R2, mode: M2, compare(t2, n2) {
    ...
    E2.value = false, V !== null && cancelAnimationFrame(V), V = requestAnimationFrame(() => {
      ...
      if (l2.virtual.value) {
        d2.value = t2 === c$1.Specific ? n2 : f$3({ focus: t2 }, { resolveItems: () => l2.virtual.value.options, resolveActiveIndex: () => {
          var C2, A2;
          return (A2 = (C2 = l2.activeOptionIndex.value) != null ? C2 : l2.virtual.value.options.findIndex((j) => {
            var q2;
            return !((q2 = l2.virtual.value) != null && q2.disabled(j));
          })) != null ? A2 : null;
        }, resolveDisabled: (C2) => l2.virtual.value.disabled(C2), resolveId() {
      ...
      if (b.activeOptionIndex === null) {
        let C2 = b.options.findIndex((A2) => !A2.dataRef.disabled);
        C2 !== -1 && (b.activeOptionIndex = C2);
      }
      let O2 = t2 === c$1.Specific ? n2 : f$3({ focus: t2 }, { resolveItems: () => b.options, resolveActiveIndex: () => b.activeOptionIndex, resolveId: (C2) => C2.id, resolveDisabled: (C2) => C2.dataRef.disabled });
    ...
    d2.value === null && l2.isSelected(n2.value.value) && (b.activeOptionIndex = b.options.indexOf(s2)), v2.value = b.options, d2.value = b.activeOptionIndex, D.value = 2, b.options.some((O2) => !o$2(O2.dataRef.domRef)) && (i2 = requestAnimationFrame(() => {
      let O2 = w2();
    ...
    let s2 = w2((b) => {
      let O2 = b.findIndex((C2) => C2.id === t2);
      return O2 !== -1 && b.splice(O2, 1), b;
    });
    v2.value = s2.options, d2.value = s2.activeOptionIndex, D.value = 2;
  }, isSelected(t2) {
    return u$5(M2.value, { [0]: () => l2.compare(toRaw(l2.value.value), toRaw(t2)), [1]: () => toRaw(l2.value.value).some((n2) => l2.compare(toRaw(n2), toRaw(t2))) });
  }, isActive(t2) {
    return d2.value === l2.calculateIndex(t2);
  } };
  w$2([e2, c2, f2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$4(computed(() => u$5(o2.value, { [0]: i$4.Open, [1]: i$4.Closed })));
  computed(() => {
    var t2;
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r, expose: y2 }) {
  ...
  return () => {
    var E2, w2;
    let v2 = { open: u2.comboboxState.value === 0, disabled: u2.disabled.value, value: u2.value.value }, { ...d2 } = a2, D = { ref: u2.buttonRef, id: o2, type: f2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (E2 = o$2(u2.optionsRef)) == null ? void 0 : E2.id, "aria-expanded": u2.comboboxState.value === 0, "aria-labelledby": u2.labelRef.value ? [(w2 = o$2(u2.labelRef)) == null ? void 0 : w2.id, o2].join(" ") : void 0, disabled: u2.disabled.value === true ? true : void 0, onKeydown: c2, onClick: e2 };
  ...
  function M2(i2) {
    switch (w2(() => {
      ...
      case o$3.Enter:
        ...
        break;
      case o$3.ArrowDown:
        return i2.preventDefault(), i2.stopPropagation(), u$5(e2.comboboxState.value, { [0]: () => e2.goToOption(c$1.Next), [1]: () => e2.openCombobox() });
      case o$3.ArrowUp:
        return i2.preventDefault(), i2.stopPropagation(), u$5(e2.comboboxState.value, { [0]: () => e2.goToOption(c$1.Previous), [1]: () => {
  ...
  function B2(i2) {
    ...
    if (!((l2 = o$2(e2.optionsRef)) != null && l2.contains(I)) && !((g2 = o$2(e2.buttonRef)) != null && g2.contains(I)) && e2.comboboxState.value === 0) return i2.preventDefault(), e2.mode.value === 0 && (e2.nullable.value && e2.value.value === null ? S2() : e2.activationTrigger.value !== 1 && e2.selectActiveOption()), e2.closeCombobox();
  }
  function p2(i2) {
    var T2, l2, g2;
    let I = (T2 = i2.relatedTarget) != null ? T2 : t$1.find((t2) => t2 !== i2.currentTarget);
  ...
  i$5({ container: computed(() => o$2(o2.optionsRef)), enabled: computed(() => o2.comboboxState.value === 0), accept(S2) {
  ...
  return () => {
    var D, E2, w2;
    let S2 = { open: o2.comboboxState.value === 0 }, v2 = { "aria-labelledby": (w2 = (D = o$2(o2.labelRef)) == null ? void 0 : D.id) != null ? w2 : (E2 = o$2(o2.buttonRef)) == null ? void 0 : E2.id, id: u2, ref: o2.optionsRef, role: "listbox", "aria-multiselectable": o2.mode.value === 1 ? true : void 0, onMousedown: f2 }, d2 = T$1(a2, ["hold"]);
...
let ue$2 = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$12, slots: r, expose: l2 }) {
  let o2 = ref(null);
  l2({ el: o2, $el: o2 });
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$2(T2, d2) || (s2.value ? P(o$2(o2), u$5(f2.value, { [d$3.Forwards]: () => N$4.Next, [d$3.Backwards]: () => N$4.Previous }) | N$4.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
    let u2 = {}, T2 = { ref: o2, onKeydown: F, onFocusout: H2 }, { features: d2, initialFocus: w2, containers: Q2, ...O2 } = t2;
    return h(Fragment, [Boolean(d2 & 4) && h(f$2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$3.Focusable }), A$3({ ourProps: T2, theirProps: { ...n$12, ...O2 }, slot: u2, attrs: n$12, slots: r, name: "FocusTrap" }), Boolean(d2 & 4) && h(f$2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$3.Focusable })]);
  };
} }), { features: A$2 });
function W$1(t2) {
...
function d$2(t2, a2, n2) {
  ...
  return watch([t2, a2], ([e2, m2], [r], o2) => {
    if (!e2 || !m2) return;
    a$1.dispatch("PUSH", e2, n2);
    let f2 = false;
    o2(() => {
      f2 || (a$1.dispatch("POP", r != null ? r : e2, n2), f2 = true);
    });
  }, { immediate: true }), l2;
}
...
function N$1({ defaultContainers: o2 = [], portals: i2, mainTreeNodeRef: H2 } = {}) {
  ...
  function u2() {
    ...
    for (let e2 of (l2 = r == null ? void 0 : r.querySelectorAll("html > *, body > *")) != null ? l2 : []) e2 !== (void 0).body && e2 !== (void 0).head && e2 instanceof HTMLElement && e2.id !== "headlessui-portal-root" && (e2.contains(o$2(t2)) || e2.contains((a2 = (f2 = o$2(t2)) == null ? void 0 : f2.getRootNode()) == null ? void 0 : a2.host) || n2.some((M2) => e2.contains(M2)) || n2.push(e2));
    return n2;
  }
...
function v() {
  ...
  return { mainTreeNodeRef: o2, MainTreeNode() {
    return h(f$2, { features: u$3.Hidden, ref: o2 });
  } };
}
...
defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: null } }, setup(t2, { attrs: o2, slots: s2 }) {
  var n2;
  let e2 = (n2 = t2.id) != null ? n2 : `headlessui-description-${i$2()}`, r = w();
  return () => {
...
let $$1 = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e2, { slots: t2, attrs: l2 }) {
  ...
  let v2 = inject(d$1, null), g2 = false;
  getCurrentInstance();
  return watch(r, () => {
    if (g2 || !v2) return;
    let a2 = o$2(r);
...
} }), d$1 = /* @__PURE__ */ Symbol("PortalParentContext");
function q() {
...
let A$1 = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A$1 }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p2, expose: s$12 }) {
  ...
  let c2 = computed(() => u2.value && R2.value ? 0 : 1), k$1 = computed(() => c2.value === 0), w2 = computed(() => D.value > 1), N2 = inject(H, null) !== null, [Q2, X] = q(), { resolveContainers: B2, mainTreeNodeRef: K2, MainTreeNode: Z } = N$1({ portals: Q2, defaultContainers: [computed(() => {
    ...
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E2.value) == null ? void 0 : e2.querySelectorAll("body > *")) != null ? a2 : []).find((f2) => f2.id === "headlessui-portal-root" ? false : f2.contains(o$2(K2)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E$1(le2, te);
  let ae2 = computed(() => w2.value ? true : k$1.value), oe = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E2.value) == null ? void 0 : e2.querySelectorAll("[data-headlessui-portal]")) != null ? a2 : []).find((f2) => f2.contains(o$2(K2)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E$1(oe, ae2), R$1({ type: "Dialog", enabled: computed(() => c2.value === 0), element: m2, onUpdate: (e2, a2) => {
    if (a2 === "Dialog") return u$5(e2, { [s.Add]: () => D.value += 1, [s.Remove]: () => D.value -= 1 });
  } });
  ...
  E$2((W2 = E2.value) == null ? void 0 : W2.defaultView, "keydown", (e2) => {
    ie2.value && (e2.defaultPrevented || e2.key === o$3.Escape && (e2.preventDefault(), e2.stopPropagation(), h$12.close()));
  });
  let ue2 = computed(() => !(U2.value || c2.value !== 0 || N2));
  return d$2(E2, ue2, (e2) => {
    var a2;
    ...
    return h(u$2, { force: true }, () => [h($$1, () => h(z, { target: m2.value }, () => h(u$2, { force: false }, () => h(ue$2, { initialFocus: a2, containers: B2, features: k$1.value ? u$5(ee.value, { parent: ue$2.features.RestoreFocus, leaf: ue$2.features.All & ~ue$2.features.FocusLock }) : ue$2.features.None }, () => h(X, {}, () => A$3({ ourProps: f2, theirProps: { ...d2, ...l2 }, slot: L2, attrs: l2, slots: p2, visible: c2.value === 0, features: N$3.RenderStrategy | N$3.Static, name: "Dialog" })))))), h(Z)]);
  };
} });
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe$1 }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w2 }) {
  ...
  let D = computed(() => o2.multiple ? 1 : 0), [y2, L2] = d$4(computed(() => o2.modelValue), (t2) => w2("update:modelValue", t2), computed(() => o2.defaultValue)), M2 = computed(() => y2.value === void 0 ? u$5(D.value, { [1]: [], [0]: void 0 }) : y2.value), k2 = { listboxState: n2, value: M2, mode: D, compare(t2, i2) {
    ...
    o2.disabled || L2(u$5(D.value, { [0]: () => t2, [1]: () => {
  ...
  w$2([f2, v2], (t2, i2) => {
    var l2;
    k2.closeListbox(), w$4(i2, h$1.Loose) || (t2.preventDefault(), (l2 = o$2(f2)) == null || l2.focus());
  }, computed(() => n2.value === 0)), provide($, k2), t$4(computed(() => u$5(n2.value, { [0]: i$4.Open, [1]: i$4.Closed })));
  computed(() => {
    var t2;
  ...
  return () => {
    ...
    return h(Fragment, [...t2 != null && M2.value != null ? e$1({ [t2]: M2.value }).map(([I, Q2]) => h(f$2, E$3({ features: u$3.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q2 }))) : [], A$3({ ourProps: {}, theirProps: { ...r, ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r }) {
  ...
  function e2() {
    var v2;
    (v2 = o$2(n2.buttonRef)) == null || v2.focus({ preventScroll: true });
  }
  return () => {
...
let je$1 = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r, expose: w2 }) {
  ...
  var C2;
  let n2 = (C2 = o2.id) != null ? C2 : `headlessui-listbox-option-${i$2()}`, e2 = A("ListboxOption"), f2 = ref(null);
  w2({ el: f2, $el: f2 });
  let v2 = computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false), s2 = computed(() => u$5(e2.mode.value, { [0]: () => e2.compare(toRaw(e2.value.value), toRaw(o2.value)), [1]: () => toRaw(e2.value.value).some((t2) => e2.compare(toRaw(t2), toRaw(o2.value))) }));
...
let ue$1 = /* @__PURE__ */ Symbol("PopoverPanelContext");
function ge$1() {
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s2, expose: h$2 }) {
  ...
  let t2 = ref(1), o2 = ref(null), y2 = ref(null), v2 = ref(null), m2 = ref(null), b = computed(() => i$3(f2)), E2 = computed(() => {
    ...
    let e2 = E$4(), r = e2.indexOf(o$2(o2)), l2 = (r + e2.length - 1) % e2.length, g2 = (r + 1) % e2.length, G = e2[l2], C2 = e2[g2];
    ...
    a2.closePopover();
    let r = (() => e2 ? e2 instanceof HTMLElement ? e2 : e2.value instanceof HTMLElement ? o$2(e2) : o$2(a2.button) : o$2(a2.button))();
    r == null || r.focus();
  } };
  provide(re, a2), t$4(computed(() => u$5(t2.value, { [0]: i$4.Open, [1]: i$4.Closed })));
  ...
  function p2() {
    var e2, r, l2, g2;
    return (g2 = c2 == null ? void 0 : c2.isFocusWithinPopoverGroup()) != null ? g2 : ((e2 = b.value) == null ? void 0 : e2.activeElement) && (((r = o$2(o2)) == null ? void 0 : r.contains(b.value.activeElement)) || ((l2 = o$2(m2)) == null ? void 0 : l2.contains(b.value.activeElement)));
  }
  return watchEffect(() => I == null ? void 0 : I(S2)), E$2((u2 = b.value) == null ? void 0 : u2.defaultView, "focus", (e2) => {
    var r, l2;
    e2.target !== void 0 && e2.target instanceof HTMLElement && t2.value === 0 && (p2() || o2 && m2 && (i2.contains(e2.target) || (r = o$2(a2.beforePanelSentinel)) != null && r.contains(e2.target) || (l2 = o$2(a2.afterPanelSentinel)) != null && l2.contains(e2.target) || a2.closePopover()));
  }, true), w$2(i2.resolveContainers, (e2, r) => {
    var l2;
    a2.closePopover(), w$4(r, h$1.Loose) || (e2.preventDefault(), (l2 = o$2(o2)) == null || l2.focus());
  }, computed(() => t2.value === 0)), () => {
  ...
  function c2(e2) {
    ...
    if (b.value) {
      ...
      switch (e2.key) {
        case o$3.Space:
        case o$3.Enter:
          e2.preventDefault(), (l2 = (r = e2.target).click) == null || l2.call(r), t2.closePopover(), (g2 = o$2(t2.button)) == null || g2.focus();
          break;
      }
    } else switch (e2.key) {
      case o$3.Space:
      ...
      case o$3.Escape:
        ...
        if (!o$2(t2.button) || (G = o2.value) != null && G.activeElement && !((C2 = o$2(t2.button)) != null && C2.contains(o2.value.activeElement))) return;
        e2.preventDefault(), e2.stopPropagation(), t2.closePopover();
        break;
    }
  }
  function I(e2) {
    b.value || e2.key === o$3.Space && e2.preventDefault();
  }
  function F(e2) {
    var r, l2;
    d2.disabled || (b.value ? (t2.closePopover(), (r = o$2(t2.button)) == null || r.focus()) : (e2.preventDefault(), e2.stopPropagation(), t2.popoverState.value === 1 && (v2 == null || v2(t2.buttonId.value)), t2.togglePopover(), (l2 = o$2(t2.button)) == null || l2.focus()));
  }
  function w2(e2) {
  ...
  function p2() {
    ...
    if (!e2) return;
    function r() {
      u$5(i2.value, { [d$3.Forwards]: () => P(e2, N$4.First), [d$3.Backwards]: () => P(e2, N$4.Last) }) === T$2.Error && P(E$4().filter((g2) => g2.dataset.headlessuiFocusGuard !== "true"), u$5(i2.value, { [d$3.Forwards]: N$4.Next, [d$3.Backwards]: N$4.Previous }), { relativeTo: o$2(t2.button) });
    }
    r();
  }
  return () => {
    let e2 = t2.popoverState.value === 0, r = { open: e2 }, { ...l2 } = d2, g2 = b.value ? { ref: E2, type: S2.value, onKeydown: c2, onClick: F } : { ref: E2, id: f2, type: S2.value, "aria-expanded": t2.popoverState.value === 0, "aria-controls": o$2(t2.panel) ? t2.panelId.value : void 0, disabled: d2.disabled ? true : void 0, onKeydown: c2, onKeyup: I, onClick: F, onMousedown: w2 };
    return h(Fragment, [A$3({ ourProps: g2, theirProps: { ...P$1, ...l2 }, slot: r, attrs: P$1, slots: s2, name: "PopoverButton" }), e2 && !b.value && t2.isPortalled.value && h(f$2, { id: a2, features: u$3.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: p2 })]);
  };
} });
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d2, { attrs: P$1, slots: s2, expose: h$12 }) {
  ...
  h$12({ el: o2.panel, $el: o2.panel }), provide(ue$1, o2.panelId), watchEffect(() => {
    var p2, u2;
  ...
  function S2(i2) {
    ...
    p2 && o$2(o2.panel) && ((u2 = o$2(o2.panel)) != null && u2.contains(p2) || (o2.closePopover(), ((r = (e2 = o$2(o2.beforePanelSentinel)) == null ? void 0 : e2.contains) != null && r.call(e2, p2) || (g2 = (l2 = o$2(o2.afterPanelSentinel)) == null ? void 0 : l2.contains) != null && g2.call(l2, p2)) && p2.focus({ preventScroll: true })));
  }
  let c2 = n();
  function I() {
    let i2 = o$2(o2.panel);
  ...
  function F() {
    ...
    function p2() {
      u$5(c2.value, { [d$3.Forwards]: () => {
        ...
        if (!u2) return;
        let r = E$4(), l2 = r.indexOf(u2), g2 = r.slice(0, l2 + 1), C2 = [...r.slice(l2 + 1), ...g2];
  ...
  return () => {
    ...
    return A$3({ ourProps: e2, theirProps: { ...P$1, ...u2 }, attrs: P$1, slot: i2, slots: { ...s2, default: (...r) => {
      var l2;
      return [h(Fragment, [E2.value && o2.isPortalled.value && h(f$2, { id: v2, ref: o2.beforePanelSentinel, features: u$3.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: I }), (l2 = s2.default) == null ? void 0 : l2.call(s2, ...r), E2.value && o2.isPortalled.value && h(f$2, { id: m2, ref: o2.afterPanelSentinel, features: u$3.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: F })])];
...
defineComponent({ name: "PopoverGroup", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { attrs: P2, slots: s2, expose: h$12 }) {
  ...
  function b() {
    ...
    return (c2 = o$2(f2)) != null && c2.contains(S2) ? true : t2.value.some((I) => {
      var F, w2;
...
defineComponent({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t2, { slots: n2, attrs: i2 }) {
  var r;
  let e2 = (r = t2.id) != null ? r : `headlessui-label-${i$2()}`, o2 = d();
  return () => {
    let { name: l2 = "Label", slot: p2 = {}, props: c2 = {} } = o2, { passive: f2, ...s2 } = t2, u2 = { ...Object.entries(c2).reduce((b, [g2, m2]) => Object.assign(b, { [g2]: unref(m2) }), {}), id: e2 };
    return f2 && (delete u2.onClick, delete u2.htmlFor, delete s2.onClick), A$3({ ourProps: u2, theirProps: s2, slot: p2, attrs: i2, slots: n2, name: l2 });
  };
} });
...
defineComponent({ name: "SwitchGroup", props: { as: { type: [Object, String], default: "template" } }, setup(l2, { slots: c2, attrs: i2 }) {
  let r = ref(null), f2 = E({ name: "SwitchLabel", props: { htmlFor: computed(() => {
    var t2;
    return (t2 = r.value) == null ? void 0 : t2.id;
  }), onClick(t2) {
    r.value && (t2.currentTarget.tagName === "LABEL" && t2.preventDefault(), r.value.click(), r.value.focus({ preventScroll: true }));
  } } }), p2 = k({ name: "SwitchDescription" });
  return provide(C, { switchRef: r, labelledby: f2, describedby: p2 }), () => A$3({ theirProps: l2, ourProps: {}, slot: {}, slots: c2, attrs: i2, name: "SwitchGroup" });
} });
let ue = defineComponent({ name: "Switch", emits: { "update:modelValue": (l2) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null }, disabled: { type: Boolean, default: false }, tabIndex: { type: Number, default: 0 } }, inheritAttrs: false, setup(l2, { emit: c2, attrs: i2, slots: r, expose: f2 }) {
  var h$12;
  let p$12 = (h$12 = l2.id) != null ? h$12 : `headlessui-switch-${i$2()}`, n2 = inject(C, null), [t2, s2] = d$4(computed(() => l2.modelValue), (e2) => c2("update:modelValue", e2), computed(() => l2.defaultChecked));
  function m2() {
    s2(!t2.value);
  }
  let E2 = ref(null), o2 = n2 === null ? E2 : n2.switchRef, L2 = s$2(computed(() => ({ as: l2.as, type: i2.type })), o2);
  f2({ el: o2, $el: o2 });
  function D(e2) {
    e2.preventDefault(), m2();
  }
  function R2(e2) {
    e2.key === o$3.Space ? (e2.preventDefault(), m2()) : e2.key === o$3.Enter && p(e2.currentTarget);
  }
  function x2(e2) {
    e2.preventDefault();
  }
  computed(() => {
    var e2, a2;
    return (a2 = (e2 = o$2(o2)) == null ? void 0 : e2.closest) == null ? void 0 : a2.call(e2, "form");
  });
  return () => {
    let { name: e2, value: a2, form: K2, tabIndex: y2, ...b } = l2, T2 = { checked: t2.value }, B2 = { id: p$12, ref: o2, role: "switch", type: L2.value, tabIndex: y2 === -1 ? 0 : y2, "aria-checked": t2.value, "aria-labelledby": n2 == null ? void 0 : n2.labelledby.value, "aria-describedby": n2 == null ? void 0 : n2.describedby.value, onClick: D, onKeyup: R2, onKeypress: x2 };
    return h(Fragment, [e2 != null && t2.value != null ? h(f$2, E$3({ features: u$3.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: t2.value, form: K2, disabled: b.disabled, name: e2, value: a2 })) : null, A$3({ ourProps: B2, theirProps: { ...i2, ...T$1(b, ["modelValue", "defaultChecked"]) }, slot: T2, attrs: i2, slots: r, name: "Switch" })]);
  };
} });
function g(e2 = "") {
...
let W = N$3.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s2, expose: h$12 }) {
  ...
  g(e2.leaveFrom);
  g(e2.leaveTo);
  return provide(N, P2), t$4(computed(() => u$5(i2.value, { ["visible"]: i$4.Open, ["hidden"]: i$4.Closed }) | n2.value)), () => {
...
const config$5 = mergeConfig(appConfig.ui.strategy, appConfig.ui.popover, popover);
const _sfc_main$9 = defineComponent({
  ...
  emits: ["update:open"],
  setup(props, { emit }) {
    const { ui, attrs } = useUI("popover", toRef(props, "ui"), config$5, toRef(props, "class"));
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$5]]);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-e0a22531"]]);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$3]]);
...
const __nuxt_component_5$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ItemForm = _sfc_main$3;
      const _component_ImportWizard = _sfc_main$2;
      ...
      _push(`</div></div><div class="mb-4 flex flex-col md:flex-row gap-2">`);
        ...
        "actions-data": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              color: "gray",
              variant: "ghost",
              onClick: ($event) => _ctx.openEditModal(row)
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_UButton, {
              icon: "i-heroicons-trash",
              size: "xs",
...
//# sourceMappingURL=index-BCbyniPv.js.map
