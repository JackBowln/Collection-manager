import { h as arrow, _ as _export_sfc, m as mergeConfig, i as useUI, t as tooltip, j as appConfig, d as __nuxt_component_1$1, c as __nuxt_component_2$1, k as get, e as __nuxt_component_5$1, l as useInjectButtonGroup, o as twMerge, s as select, p as selectMenu, f as useToast, b as useUserSession, g as useRoute } from "../server.mjs";
import { i as i$3, u as u$2, l as l$1, a as i$4, b as i$5, w as w$1, t as t$4, c as c$1, f as f$2, O, n as n$1, d as c$2, e as w$2, S, P, N as N$4, g as t$5, p, h as w$3, j as h$1, E as E$3, T as T$2, s as s$3, _ as __nuxt_component_0, k as usePopper } from "./usePopper-wR_LLQw2.js";
import { defineComponent, computed, ref, inject, watchEffect, nextTick, watch, provide, h, Fragment, toRaw, reactive, cloneVNode, shallowRef, getCurrentInstance, Teleport, normalizeClass, mergeProps, withCtx, createTextVNode, toDisplayString, toRef, useSlots, useSSRContext, unref, createVNode, createBlock, createCommentVNode, openBlock, renderList, createSlots, resolveComponent, renderSlot, Transition, useId, resolveDynamicComponent, isRef, withAsyncContext } from "C:/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/index.mjs";
import { defu } from "C:/Users/viniv/Desktop/dev/collection-manager/node_modules/defu/dist/defu.mjs";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderVNode } from "vue/server-renderer";
import { _ as __nuxt_component_9 } from "./Card-CjK8ZZ2Z.js";
import { a as __nuxt_component_4, u as useFormGroup, _ as __nuxt_component_3$1 } from "./Input-CWRe9pxK.js";
import { twJoin } from "tailwind-merge";
import { _ as __nuxt_component_5$2 } from "./Badge-Bm7uoIiW.js";
...
import { d as d$3, e as e$1, f as f$1, u as u$4, k, _ as __nuxt_component_3$2 } from "./Toggle-JvMqr6TW.js";
import { c as __nuxt_component_0$1, _ as __nuxt_component_1$2, d as __nuxt_component_1$3, a as _sfc_main$d, b as _sfc_main$e } from "./FieldDefinition-WmOpqtMW.js";
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    computed(() => props.fields.filter((f2) => f2.type === "date"));
    const expandedStates = reactive(/* @__PURE__ */ new Set());
    const toggleExpand = (id) => {
      if (expandedStates.has(id)) expandedStates.delete(id);
      else expandedStates.add(id);
    };
    const isExpanded = (id) => expandedStates.has(id);
    const getAvg = (fieldId) => {
      const validItems = props.items.filter((row) => {
        const val = row[fieldId];
        return val !== null && val !== void 0 && val !== "" && !isNaN(Number(val));
      });
    ...
    const getMax = (fieldId) => {
      const vals = props.items.map((row) => Number(row[fieldId]) || 0).filter((v2) => v2 !== 0);
    ...
    const getDistribution = (fieldId, expanded) => {
      const counts = {};
      ...
      let sorted = Object.entries(counts).sort(([, a2], [, b]) => b - a2);
    ...
    const sortedItemsByDate = computed(() => {
      return [...props.items].sort((a2, b) => new Date(a2.created_at).getTime() - new Date(b.created_at).getTime());
    });
    const oldestItemDate = computed(() => sortedItemsByDate.value[0] ? new Date(sortedItemsByDate.value[0].created_at) : /* @__PURE__ */ new Date());
    const newestItemDate = computed(() => sortedItemsByDate.value[props.items.length - 1] ? new Date(sortedItemsByDate.value[props.items.length - 1].created_at) : /* @__PURE__ */ new Date());
    const itemsLastMonth = computed(() => {
      const thirtyDaysAgo = /* @__PURE__ */ new Date();
      thirtyDaysAgo.setDate(thirtyDaysAgo.getDate() - 30);
      return props.items.filter((i2) => new Date(i2.created_at) >= thirtyDaysAgo).length;
    });
    ...
    computed(() => {
      ...
      numericFields.value.forEach((numField) => {
        distributionFields.value.forEach((catField) => {
          if (catField.type === "boolean") return;
          const groups = {};
          props.items.forEach((row) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.fields.length > 0 && __props.items.length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "mb-8 space-y-8 animate-fade-in" }, _attrs))} data-v-ba1dd182>`);
        _push(ssrRenderComponent(_component_UCard, { class: "bg-gradient-to-br from-gray-900 to-gray-800 text-white shadow-xl overflow-hidden border-0" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex flex-col md:flex-row gap-8" data-v-ba1dd182${_scopeId}><div class="md:w-1/3 space-y-6 z-10" data-v-ba1dd182${_scopeId}><div data-v-ba1dd182${_scopeId}><p class="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1" data-v-ba1dd182${_scopeId}>Total na Coleção</p><p class="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-indigo-400" data-v-ba1dd182${_scopeId}>${ssrInterpolate(__props.items.length)} <span class="text-lg text-gray-500 font-normal" data-v-ba1dd182${_scopeId}>itens</span></p></div><div class="space-y-2" data-v-ba1dd182${_scopeId}><div class="flex items-center gap-2 text-sm text-gray-300" data-v-ba1dd182${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "i-heroicons-calendar",
                class: "w-4 h-4 text-primary-400"
              }, null, _parent2, _scopeId));
              _push2(`<span data-v-ba1dd182${_scopeId}>Criado em: <span class="font-bold text-white" data-v-ba1dd182${_scopeId}>${ssrInterpolate(formatDate(unref(oldestItemDate)))}</span></span></div><div class="flex items-center gap-2 text-sm text-gray-300" data-v-ba1dd182${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "i-heroicons-clock",
                class: "w-4 h-4 text-primary-400"
              }, null, _parent2, _scopeId));
              _push2(`<span data-v-ba1dd182${_scopeId}>Última adição: <span class="font-bold text-white" data-v-ba1dd182${_scopeId}>${ssrInterpolate(formatDate(unref(newestItemDate)))}</span></span></div></div>`);
              if (unref(growthRate) > 0) {
                _push2(`<div class="inline-flex items-center gap-1.5 px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-bold" data-v-ba1dd182${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: "i-heroicons-arrow-trending-up",
                  class: "w-3 h-3"
                }, null, _parent2, _scopeId));
                _push2(` +${ssrInterpolate(unref(growthRate))}% este mês </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="md:w-2/3 h-48 flex items-end gap-2 relative" data-v-ba1dd182${_scopeId}><div class="absolute inset-0 flex flex-col justify-between pointer-events-none opacity-10" data-v-ba1dd182${_scopeId}><div class="border-t border-white w-full" data-v-ba1dd182${_scopeId}></div><div class="border-t border-white w-full" data-v-ba1dd182${_scopeId}></div><div class="border-t border-white w-full" data-v-ba1dd182${_scopeId}></div></div><!--[-->`);
              ssrRenderList(unref(timeSeriesData), (point, idx) => {
                _push2(`<div class="flex-1 flex flex-col justify-end group relative items-center" data-v-ba1dd182${_scopeId}><div class="w-full bg-primary-500/50 group-hover:bg-primary-400 transition-all rounded-t-sm relative" style="${ssrRenderStyle({ height: `${point.percent}%` })}" data-v-ba1dd182${_scopeId}><div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-white text-gray-900 text-[10px] px-2 py-1 rounded font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-20 shadow-lg" data-v-ba1dd182${_scopeId}>${ssrInterpolate(point.label)}: ${ssrInterpolate(point.count)} items </div></div><p class="text-[9px] text-gray-500 mt-2 font-mono hidden sm:block" data-v-ba1dd182${_scopeId}>${ssrInterpolate(point.shortLabel)}</p></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              return [
                createVNode("div", { class: "flex flex-col md:flex-row gap-8" }, [
                  createVNode("div", { class: "md:w-1/3 space-y-6 z-10" }, [
                    createVNode("div", null, [
                      createVNode("p", { class: "text-xs font-bold uppercase tracking-widest text-gray-400 mb-1" }, "Total na Coleção"),
                      createVNode("p", { class: "text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-indigo-400" }, [
                        createTextVNode(toDisplayString(__props.items.length) + " ", 1),
                        createVNode("span", { class: "text-lg text-gray-500 font-normal" }, "itens")
                      ])
                    ]),
                    createVNode("div", { class: "space-y-2" }, [
                      createVNode("div", { class: "flex items-center gap-2 text-sm text-gray-300" }, [
                        createVNode(_component_UIcon, {
                          name: "i-heroicons-calendar",
                          class: "w-4 h-4 text-primary-400"
                        }),
                        createVNode("span", null, [
                          createTextVNode("Criado em: "),
                          createVNode("span", { class: "font-bold text-white" }, toDisplayString(formatDate(unref(oldestItemDate))), 1)
                        ])
                      ]),
                      createVNode("div", { class: "flex items-center gap-2 text-sm text-gray-300" }, [
                        createVNode(_component_UIcon, {
                        ...
                        createVNode("span", null, [
                          createTextVNode("Última adição: "),
                          createVNode("span", { class: "font-bold text-white" }, toDisplayString(formatDate(unref(newestItemDate))), 1)
                        ])
                      ])
                    ]),
                    unref(growthRate) > 0 ? (openBlock(), createBlock("div", {
                      key: 0,
                      ...
                      createTextVNode(" +" + toDisplayString(unref(growthRate)) + "% este mês ", 1)
                    ])) : createCommentVNode("", true)
                  ]),
                  createVNode("div", { class: "md:w-2/3 h-48 flex items-end gap-2 relative" }, [
                    createVNode("div", { class: "absolute inset-0 flex flex-col justify-between pointer-events-none opacity-10" }, [
                      createVNode("div", { class: "border-t border-white w-full" }),
                      createVNode("div", { class: "border-t border-white w-full" }),
                      createVNode("div", { class: "border-t border-white w-full" })
                    ]),
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(timeSeriesData), (point, idx) => {
                      return openBlock(), createBlock("div", {
                        key: idx,
                        class: "flex-1 flex flex-col justify-end group relative items-center"
                      }, [
                        createVNode("div", {
                          class: "w-full bg-primary-500/50 group-hover:bg-primary-400 transition-all rounded-t-sm relative",
                          style: { height: `${point.percent}%` }
                        }, [
                          createVNode("div", { class: "absolute -top-10 left-1/2 -translate-x-1/2 bg-white text-gray-900 text-[10px] px-2 py-1 rounded font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-20 shadow-lg" }, toDisplayString(point.label) + ": " + toDisplayString(point.count) + " items ", 1)
                        ], 4),
                        createVNode("p", { class: "text-[9px] text-gray-500 mt-2 font-mono hidden sm:block" }, toDisplayString(point.shortLabel), 1)
                      ]);
                    }), 128))
                  ])
                ])
        ...
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4" data-v-ba1dd182><!--[-->`);
        ssrRenderList(unref(numericFields), (field) => {
          _push(ssrRenderComponent(_component_UCard, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex items-start justify-between mb-4" data-v-ba1dd182${_scopeId}><div data-v-ba1dd182${_scopeId}><p class="text-[10px] uppercase font-bold text-gray-400 tracking-wider mb-0.5" data-v-ba1dd182${_scopeId}>${ssrInterpolate(field.name)}</p><p class="text-2xl font-black font-mono" data-v-ba1dd182${_scopeId}>${ssrInterpolate(formatValue(getAvg(field.id)))} <span class="text-xs font-normal text-gray-400" data-v-ba1dd182${_scopeId}>média</span></p></div>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: "i-heroicons-calculator",
                  class: "w-8 h-8 text-gray-100 dark:text-gray-800"
                }, null, _parent2, _scopeId));
                _push2(`</div><div class="flex items-end gap-1 h-8 mt-2 pb-1 border-b border-gray-100 dark:border-gray-800 mb-2" data-v-ba1dd182${_scopeId}><div class="w-1/3 bg-blue-100 dark:bg-blue-900/20 rounded-t h-full relative group" data-v-ba1dd182${_scopeId}><span class="absolute -top-4 w-full text-center text-[9px] text-blue-500 font-bold opacity-0 group-hover:opacity-100 transition-opacity" data-v-ba1dd182${_scopeId}>Min</span></div><div class="w-1/3 bg-gray-100 dark:bg-gray-800 rounded-t h-1/2 mx-auto" data-v-ba1dd182${_scopeId}></div><div class="w-1/3 bg-orange-100 dark:bg-orange-900/20 rounded-t h-[80%] relative group" data-v-ba1dd182${_scopeId}><span class="absolute -top-4 w-full text-center text-[9px] text-orange-500 font-bold opacity-0 group-hover:opacity-100 transition-opacity" data-v-ba1dd182${_scopeId}>Max</span></div></div><div class="flex justify-between text-xs font-mono" data-v-ba1dd182${_scopeId}><span class="text-blue-500" data-v-ba1dd182${_scopeId}>Min: ${ssrInterpolate(formatValue(getMin(field.id)))}</span><span class="text-orange-500" data-v-ba1dd182${_scopeId}>Max: ${ssrInterpolate(formatValue(getMax(field.id)))}</span></div>`);
              } else {
                return [
                  createVNode("div", { class: "flex items-start justify-between mb-4" }, [
                    createVNode("div", null, [
                      createVNode("p", { class: "text-[10px] uppercase font-bold text-gray-400 tracking-wider mb-0.5" }, toDisplayString(field.name), 1),
                      createVNode("p", { class: "text-2xl font-black font-mono" }, [
                        createTextVNode(toDisplayString(formatValue(getAvg(field.id))) + " ", 1),
                        createVNode("span", { class: "text-xs font-normal text-gray-400" }, "média")
                      ])
                    ]),
                    createVNode(_component_UIcon, {
                      name: "i-heroicons-calculator",
                  ...
                  createVNode("div", { class: "flex items-end gap-1 h-8 mt-2 pb-1 border-b border-gray-100 dark:border-gray-800 mb-2" }, [
                    createVNode("div", { class: "w-1/3 bg-blue-100 dark:bg-blue-900/20 rounded-t h-full relative group" }, [
                      createVNode("span", { class: "absolute -top-4 w-full text-center text-[9px] text-blue-500 font-bold opacity-0 group-hover:opacity-100 transition-opacity" }, "Min")
                    ]),
                    createVNode("div", { class: "w-1/3 bg-gray-100 dark:bg-gray-800 rounded-t h-1/2 mx-auto" }),
                    createVNode("div", { class: "w-1/3 bg-orange-100 dark:bg-orange-900/20 rounded-t h-[80%] relative group" }, [
                      createVNode("span", { class: "absolute -top-4 w-full text-center text-[9px] text-orange-500 font-bold opacity-0 group-hover:opacity-100 transition-opacity" }, "Max")
                    ])
                  ]),
                  createVNode("div", { class: "flex justify-between text-xs font-mono" }, [
                    createVNode("span", { class: "text-blue-500" }, "Min: " + toDisplayString(formatValue(getMin(field.id))), 1),
                    createVNode("span", { class: "text-orange-500" }, "Max: " + toDisplayString(formatValue(getMax(field.id))), 1)
                  ])
                ];
              }
            }),
        ...
        ssrRenderList(unref(distributionFields), (field) => {
          _push(ssrRenderComponent(_component_UCard, {
            ...
            header: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex items-center gap-2" data-v-ba1dd182${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: "i-heroicons-chart-pie",
                  class: "w-4 h-4 text-gray-400"
                }, null, _parent2, _scopeId));
                _push2(`<h3 class="font-bold text-sm" data-v-ba1dd182${_scopeId}>${ssrInterpolate(field.name)}</h3></div>`);
              } else {
                return [
            ...
            footer: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                if (getUniqueCount(field.id) > 5) {
                  _push2(`<button class="w-full text-center text-[10px] font-bold uppercase tracking-wider text-gray-400 hover:text-primary-500 transition-colors py-1" data-v-ba1dd182${_scopeId}>${ssrInterpolate(isExpanded(field.id) ? "Mostrar menos" : `Mostrar mais (${getUniqueCount(field.id) - 5})`)}</button>`);
                } else {
                  _push2(`<!---->`);
                }
              } else {
                return [
                  getUniqueCount(field.id) > 5 ? (openBlock(), createBlock("button", {
                    key: 0,
                    onClick: ($event) => toggleExpand(field.id),
                  ...
                  }, toDisplayString(isExpanded(field.id) ? "Mostrar menos" : `Mostrar mais (${getUniqueCount(field.id) - 5})`), 9, ["onClick"])) : createCommentVNode("", true)
                ];
              }
            }),
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="space-y-3" data-v-ba1dd182${_scopeId}>`);
                if (isExpanded(field.id) && getUniqueCount(field.id) > 10) {
                  _push2(`<div class="mb-2" data-v-ba1dd182${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_UInput, {
                    modelValue: unref(searchTerms)[field.id],
                    "onUpdate:modelValue": ($event) => unref(searchTerms)[field.id] = $event,
                    icon: "i-heroicons-magnifying-glass",
                    size: "xs",
                    placeholder: "Buscar...",
                    ui: { icon: { trailing: { pointer: "" } } }
                  }, createSlots({ _: 2 }, [
                    unref(searchTerms)[field.id] ? {
                      name: "trailing",
                      fn: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          _push3(ssrRenderComponent(_component_UButton, {
                            ...
                            padded: false,
                            onClick: ($event) => unref(searchTerms)[field.id] = ""
                ...
                _push2(`<div class="${ssrRenderClass({ "max-h-60 overflow-y-auto pr-1 custom-scrollbar": isExpanded(field.id) && getUniqueCount(field.id) > 5 })}" data-v-ba1dd182${_scopeId}><!--[-->`);
                ssrRenderList(getDistribution(field.id, isExpanded(field.id)), (count, option) => {
                  _push2(`<div class="space-y-1.5 mb-3 last:mb-0" data-v-ba1dd182${_scopeId}><div class="flex justify-between items-center text-xs" data-v-ba1dd182${_scopeId}><span class="font-semibold text-gray-700 dark:text-gray-300 truncate max-w-[150px]"${ssrRenderAttr("title", option)} data-v-ba1dd182${_scopeId}>${ssrInterpolate(option)}</span><div class="flex items-center gap-2" data-v-ba1dd182${_scopeId}><span class="font-mono" data-v-ba1dd182${_scopeId}>${ssrInterpolate(count)}</span><span class="text-gray-400 bg-gray-100 dark:bg-gray-800 px-1.5 rounded text-[10px]" data-v-ba1dd182${_scopeId}>${ssrInterpolate(getPercentage(count, __props.items.length))}%</span></div></div>`);
                ...
                _push2(`<!--]-->`);
                if (isExpanded(field.id) && Object.keys(getDistribution(field.id, true)).length === 0) {
                  _push2(`<div class="text-center py-4 text-xs text-gray-400" data-v-ba1dd182${_scopeId}> Nenhum resultado encontrado </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
                ...
                return [
                  createVNode("div", { class: "space-y-3" }, [
                    isExpanded(field.id) && getUniqueCount(field.id) > 10 ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "mb-2"
                    }, [
                    ...
                    createVNode("div", {
                      class: { "max-h-60 overflow-y-auto pr-1 custom-scrollbar": isExpanded(field.id) && getUniqueCount(field.id) > 5 }
                    }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(getDistribution(field.id, isExpanded(field.id)), (count, option) => {
                        return openBlock(), createBlock("div", {
                          key: option,
                          class: "space-y-1.5 mb-3 last:mb-0"
                        }, [
                          createVNode("div", { class: "flex justify-between items-center text-xs" }, [
                            createVNode("span", {
                              class: "font-semibold text-gray-700 dark:text-gray-300 truncate max-w-[150px]",
                              title: option
                            }, toDisplayString(option), 9, ["title"]),
                            createVNode("div", { class: "flex items-center gap-2" }, [
                      ...
                      isExpanded(field.id) && Object.keys(getDistribution(field.id, true)).length === 0 ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "text-center py-4 text-xs text-gray-400"
                      }, " Nenhum resultado encontrado ")) : createCommentVNode("", true)
                    ], 2)
                  ])
                ];
              }
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-ba1dd182"]]);
...
const __nuxt_component_6$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$4]]);
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$3]]);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const loadDynamicOptions = async (fieldId) => {
      if (dynamicOptions[fieldId]) return;
      try {
        const data = await $fetch(`/api/collections/${props.collectionId}/fields/${fieldId}/values`);
        dynamicOptions[fieldId] = data;
      } catch (e2) {
        console.error("Failed to load dynamic options", e2);
    ...
    watch(() => props.fields, (newFields) => {
      newFields.forEach((f2) => {
        ...
        if (f2.is_dynamic && ["select", "multiselect"].includes(f2.type)) {
          loadDynamicOptions(f2.id);
        }
      });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UToggle = __nuxt_component_3$2;
      ...
      try {
        await $fetch(`/api/collections/${props.collectionId}`, {
          ...
          body: {
            ...
            fields: form.fields.map((f2, index) => ({ ...f2, folder_order: index }))
          }
        });
  ...
  setup(__props) {
    ...
    const loadComments = async () => {
      try {
        ...
        console.error("Error loading comments:", e2);
      }
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: collectionData, pending: pendingCollection, refresh: refreshCollection } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/collections/${collectionId}`, "$YvuAMkTrJu")), __temp = await __temp, __restore(), __temp);
    const { data: itemsData, pending: pendingItems, refresh: refreshItems } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/collections/${collectionId}/items`, "$X6wPRWXIeO")), __temp = await __temp, __restore(), __temp);
    watchEffect(() => {
      if (collectionData.value) {
        collection.value = collectionData.value;
        fields.value = (collectionData.value.fields || []).sort((a2, b) => a2.folder_order - b.folder_order);
      }
      if (itemsData.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIcon = __nuxt_component_1$1;
      const _component_CollectionStats = __nuxt_component_3;
      const _component_UInput = __nuxt_component_4;
      const _component_UBadge = __nuxt_component_5$2;
      const _component_UPopover = __nuxt_component_6$1;
      ...
      _push(ssrRenderComponent(_component_UInput, {
        ...
        unref(searchQuery) || unref(activeFiltersCount) > 0 ? {
          name: "trailing",
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UBadge, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(unref(filteredRows).length)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(unref(filteredRows).length), 1)
                    ];
                  }
                }),
                _: 1
                ...
                if (_push3) {
                  ...
                  return [
                    unref(fields).length > 0 ? (openBlock(), createBlock(_component_ItemForm, {
                      ...
                      onSave: handleSave,
                      onCancel: ($event) => isOpen.value = false
                    }, null, 8, ["fields", "initial-data", "loading", "collection-id", "onCancel"])) : createCommentVNode("", true)
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=index-bNRmuSwm.js.map
