import { defineComponent, mergeProps, toRef, ref, watch, nextTick, computed, useSSRContext, useId as useId$1, inject, createSlots, withCtx, renderSlot, provide, unref, isRef, createVNode, createTextVNode, createBlock, withKeys, openBlock, Fragment, renderList, toDisplayString, createCommentVNode } from "C:/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/index.mjs";
import { twJoin } from "tailwind-merge";
import { defu } from "C:/Users/viniv/Desktop/dev/collection-manager/node_modules/defu/dist/defu.mjs";
import { _ as _export_sfc, m as mergeConfig, i as useUI, o as twMerge, j as appConfig, q as textarea, r as looseToNumber, k as get, f as useToast, c as __nuxt_component_2, e as __nuxt_component_5, d as __nuxt_component_1$3, l as useInjectButtonGroup, s as select } from "../server.mjs";
import { u as useFormGroup, a as __nuxt_component_4, _ as __nuxt_component_3 } from "./Input-CWRe9pxK.js";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrRenderClass, ssrLooseEqual, ssrGetDynamicModelProps, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrLooseContain, ssrIncludeBooleanAttr } from "vue/server-renderer";
...
const config$4 = mergeConfig(appConfig.ui.strategy, appConfig.ui.textarea, textarea);
const _sfc_main$6 = defineComponent({
  ...
  setup(props, { emit }) {
    const { ui, attrs } = useUI("textarea", toRef(props, "ui"), config$4, toRef(props, "class"));
    const { emitFormBlur, emitFormInput, inputId, color, size, name } = useFormGroup(props, config$4);
...
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$4]]);
const config$3 = mergeConfig(appConfig.ui.strategy, appConfig.ui.radio, radio);
const _sfc_main$5 = defineComponent({
  ...
  setup(props, { emit }) {
    const { ui, attrs } = useUI("radio", toRef(props, "ui"), config$3, toRef(props, "class"));
    const inputId = props.id ?? useId$1();
    const radioGroup2 = inject("radio-group", null);
    const { emitFormChange, color, name } = radioGroup2 ?? useFormGroup(props, config$3);
    const pick = computed({
      get() {
...
const config$2 = mergeConfig(appConfig.ui.strategy, appConfig.ui.radioGroup, radioGroup);
const configRadio = mergeConfig(appConfig.ui.strategy, appConfig.ui.radio, radio);
const _sfc_main$4 = defineComponent({
  components: {
    URadio: __nuxt_component_0$1
  },
  inheritAttrs: false,
  props: {
    modelValue: {
  ...
  emits: ["update:modelValue", "change"],
  setup(props, { emit }) {
    const { ui, attrs } = useUI("radioGroup", toRef(props, "ui"), config$2, toRef(props, "class"));
    const { ui: uiRadio } = useUI("radio", toRef(props, "uiRadio"), configRadio);
    const { emitFormChange, color, name } = useFormGroup(props, config$2, false);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_URadio = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: _ctx.ui.wrapper
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_URadioGroup = __nuxt_component_1$1;
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-cbc9516f"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (["select", "multiselect"].includes(unref(field).type)) {
              _push2(`<div class="md:col-span-2 space-y-3"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UCheckbox, {
                modelValue: unref(field).is_dynamic,
                "onUpdate:modelValue": ($event) => unref(field).is_dynamic = $event,
            ...
            return [
              createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                ...
                ["select", "multiselect"].includes(unref(field).type) ? (openBlock(), createBlock("div", {
                  key: 0,
                  ...
                  !unref(field).is_dynamic ? (openBlock(), createBlock(_component_UFormGroup, {
                    key: 0,
                    label: "Opções (separadas por vírgula)",
                    required: ""
                  }, {
...
//# sourceMappingURL=FieldDefinition-WmOpqtMW.js.map
