import { b as useUserSession, f as useToast, c as __nuxt_component_2, d as __nuxt_component_1, n as navigateTo, e as __nuxt_component_5$1 } from "../server.mjs";
...
import { defineComponent, withAsyncContext, ref, unref, withCtx, createTextVNode, createVNode, toDisplayString, withModifiers, useSSRContext } from "C:/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/index.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: collections, pending, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/collections", "$wSvT53YUKM")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`</div>`);
      } else if (!unref(collections)?.length) {
...
//# sourceMappingURL=index-D2GCUBgu.js.map
