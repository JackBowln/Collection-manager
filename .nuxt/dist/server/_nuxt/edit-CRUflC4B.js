import { g as useRoute, f as useToast, n as navigateTo, c as __nuxt_component_2 } from "../server.mjs";
...
import { defineComponent, ref, reactive, withAsyncContext, watchEffect, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext } from "C:/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/index.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, error } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/collections/${collectionId}`, "$lvG1zHeC2p")), __temp = await __temp, __restore(), __temp);
    watchEffect(() => {
      if (data.value) {
        const d = data.value;
        form.name = d.name;
        ...
        form.fields = (d.fields || []).sort((a, b) => a.folder_order - b.folder_order).map((f) => ({ ...f, is_dynamic: !!f.is_dynamic, selected: false }));
      }
      if (error.value) {
...
//# sourceMappingURL=edit-CRUflC4B.js.map
