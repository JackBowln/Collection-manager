...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, removeResponseHeader, getQuery as getQuery$1, readBody, handleCors, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, sendNoContent, assertMethod, readFormData, setHeader, getValidatedRouterParams, getValidatedQuery, getHeader, getRequestWebStream, readValidatedBody, getResponseStatusText } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/@vue/shared/dist/shared.cjs.js';
import { createFetch, Headers as Headers$1, ofetch } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/ofetch/dist/node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unstorage/dist/index.mjs';
import httpDriver from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unstorage/drivers/http.mjs';
import cloudflareKVBindingDriver from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unstorage/drivers/cloudflare-kv-binding.mjs';
import mime from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/mime/dist/src/index.js';
import { z } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/zod/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/defu/dist/defu.mjs';
import { randomUUID } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/uncrypto/dist/crypto.node.mjs';
import { parse } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/@nuxthub/core/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/hookable/dist/index.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/scule/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/source-map/source-map.js';
import { stringify, uneval } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/.nuxt/nuxt-icon-server-bundle.mjs';

const serverAssets = [{"baseName":"server","dir":"/mnt/c/Users/viniv/Desktop/dev/collection-manager/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/c/Users/viniv/Desktop/dev/collection-manager","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/c/Users/viniv/Desktop/dev/collection-manager/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/c/Users/viniv/Desktop/dev/collection-manager/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/c/Users/viniv/Desktop/dev/collection-manager/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/mnt/c/Users/viniv/Desktop/dev/collection-manager/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      "url": "https://jnkddzferridigmsunwr.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impua2RkemZlcnJpZGlnbXN1bndyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU4ODc4NjAsImV4cCI6MjA4MTQ2Mzg2MH0.V8IhzfnJD_X9YmoAnGTrTwEL6Cf59q7xvmN0D6fzkj4",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
      ...
      "cookieName": "sb",
      "cookiePrefix": "sb-jnkddzferridigmsunwr-auth-token",
      "useSsrCookies": true,
      "cookieOptions": {
        "maxAge": 28800,
        "sameSite": "lax",
  ...
  "hub": {
    ...
    "projectKey": "collection-mana-zgz5",
    "userToken": "user_EXsDhLwRywLxgQJacxT6XVDeLk4qRR",
    "remote": "",
    "remoteManifest": "",
    "dir": ".data/hub",
    "ai": false,
...
const _BTFQvPtX62ROC6bM8bsMoIvYTPe_lGPurwzqyDtwdk = (function(nitro) {
...
const _PwrqHNtbN7jjgwiQ4q9Lb3rGKWWrVU9cqKpcJURXXuk = defineNitroPlugin(async () => {
  await globalThis.__env__;
  await hubHooks.callHookParallel("bindings:ready");
});

const rootDir = "/mnt/c/Users/viniv/Desktop/dev/collection-manager";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap"}],"style":[{"children":"body { font-family: \"Inter\", sans-serif; }"}],"script":[],"noscript":[]};
...
const _Z1Ak2MQA9PWJNUMKXuJBLOhNPudYcTKOC4LJdZAvsI = (nitroApp) => {
...
const _I3eLXewOmB1pdH7J5oav_DgW4204rkzhbhQHSxZU = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _BTFQvPtX62ROC6bM8bsMoIvYTPe_lGPurwzqyDtwdk,
_PwrqHNtbN7jjgwiQ4q9Lb3rGKWWrVU9cqKpcJURXXuk,
_Z1Ak2MQA9PWJNUMKXuJBLOhNPudYcTKOC4LJdZAvsI,
_I3eLXewOmB1pdH7J5oav_DgW4204rkzhbhQHSxZU
];
...
const _kSTdqK = eventHandler((event) => {
...
const getServerEntry = () => import('file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///mnt/c/Users/viniv/Desktop/dev/collection-manager/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _0T905A = defineCachedEventHandler(async (event) => {
...
const _TxdxHh = eventHandler((event) => {
  handleCors(event, {
    methods: "*",
    origin: [
...
const _lazy_VF_fnM = () => Promise.resolve().then(function () { return ____feature_$1; });
const _lazy_0R_i7C = () => Promise.resolve().then(function () { return index_head$1; });
const _lazy_eV7oRR = () => Promise.resolve().then(function () { return manifest_get$1; });
const _lazy_4ORIxf = () => Promise.resolve().then(function () { return openapi_get$1; });
const _lazy_X6oJ6J = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _kSTdqK, lazy: false, middleware: true, method: undefined },
  { route: '/api/_hub/**:feature', handler: _lazy_VF_fnM, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _lazy_0R_i7C, lazy: true, middleware: false, method: "head" },
  { route: '/api/_hub/manifest', handler: _lazy_eV7oRR, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/openapi', handler: _lazy_4ORIxf, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_X6oJ6J, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _0T905A, lazy: false, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _TxdxHh, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_X6oJ6J, lazy: true, middleware: false, method: undefined }
];
...
function proxyHubVectorize(index, projectUrl, secretKey) {
  requireNuxtHubFeature("vectorize");
...
const openapi$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: openapi
}, Symbol.toStringTag, { value: 'Module' }));
